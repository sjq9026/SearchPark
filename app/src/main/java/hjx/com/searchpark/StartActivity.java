...
public class StartActivity extends AppCompatActivity {
    ...
    private void runApp() {
        //初始化SDK
        AdManager.getInstance(mContext).init("5e29d5cb8696208b", "69c259d6ff5e237c");
        //设置开屏
        setupSplashAd();
    }
        ...
        SpotManager.getInstance(mContext)
                .showSplashSpotAds(mContext, splashView, new SpotDialogListener() {
                    ...
                    public void onShowSuccess() {
                        ...
                        splashLayout.startAnimation(AnimationUtils.loadAnimation(StartActivity.this, R.anim.anim_splash_enter));
                    }
